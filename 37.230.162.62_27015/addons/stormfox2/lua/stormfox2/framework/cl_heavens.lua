...
-- SkyRender
	...
	hook.Add("PostDraw2DSkyBox", "StormFox2.SkyBoxRender", function()
		...
		cam.Start3D( vector_origin, EyeAngles() ,nil,nil,nil,nil,nil,1,32000)  -- 2d maps fix
			if not use_2d or not sky then
				-- StormFox2.Skybox2D.StarRender(c_pos)
				-- StormFox2.Skybox2D.BlockStarRender(c_pos)
				StormFox2.Skybox2D.SunRender(c_pos) -- No need to block, shrink the sun.		

				StormFox2.Skybox2D.Moon(c_pos)
			end
			-- StormFox2.Skybox2D.CloudBox(c_pos)
			StormFox2.Skybox2D.CloudLayer(c_pos)
			-- StormFox2.Skybox2D.PostCloudLayer(c_pos)
			StormFox2.Skybox2D.FogLayer(c_pos)
		cam.End3D()
...
-- Render Sun
	...
	local sunDot = 1
	function StormFox2.Skybox2D.SunRender(c_pos)
...
-- Render moon
	...
	function StormFox2.Skybox2D.Moon(c_pos)
...
-- Render Sky
local scale = 256 * 1.5
local galixmat = Material("stormfox2/effects/nightsky2")
local c = Color(255,255,255)
function StormFox2.Skybox2D.StarRender(c_pos)
