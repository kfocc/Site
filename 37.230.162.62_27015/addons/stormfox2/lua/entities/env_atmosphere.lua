...
function ENT:Initialize()
	...
	table.insert(atmosphere_ents, self)
end

function ENT:OnRemove()
	table.RemoveByValue(atmosphere_ents, self)
end
...
if SERVER then
	...
	hook.Add("Think", "StormFox2.Weather.EController", function()
		...
		local t = {}
		for _, ent in ipairs( atmosphere_ents ) do
			local p = ent:GetPos()
	...
	hook.Add("PreDrawHalos", "StormFox2.Atmosphere.Halo", function()
		...
		halo.Add( atmosphere_ents, color_white, 2, 2, 1, true,true )
	end)
end