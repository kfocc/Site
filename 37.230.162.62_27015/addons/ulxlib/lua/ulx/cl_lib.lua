...
local function rcvBlind( _,ply )
	local bool = net.ReadBool()
	local amt = net.ReadShort()
...
local function rcvVote( _,ply )
	local title = net.ReadString()
	local timeout = net.ReadShort()
	local options = ULib.umsgRcv( _ )
