...
function ENT:Draw(flags)
	...
	nameplates.DrawNPC(self, origin + Vector(0, 0, 75), LocalPlayer():GetAngles(), "C17.MPF.DISPENSER", 256, col.w, "Выдает форму для службы", self.Icon)
end
...
local buttons = {
	{
		text = "Здравствуйте. Я ознакомлен с уставом и всеми правилами, разрешите взять форму?",
	...
	{
		text = "[Важно] Расскажите о юнитах гражданской обороны",
		func = function(npc, menu) gui.OpenURL("https://f.unionrp.info/threads/5433/#post-119088") end
	},
	{
...
local nice_text = "Гражданин вы за формой? Обязательно изучите устав и все правила на этих буклетах с пометкой [Важно]. Если вам нужны буклеты, я могу выдать их вам для изучения."
function ENT:OnOpen()
