...
function ENT:IsDisabled()
	return self:GetDisabled() and true or false
end
...
-- ENT.ErrorSound = {true,2,"Resource/warning.wav"}
-- ENT.RuningSound = {true,5,"ambient/machines/engine4.wav"}
