...
-- 		timer.Simple(10, SpawnTextScreens)
-- 	end)
...
hook.Add("PlayerFootstep","Cloak_Hidden_Footstep",function(ply)
	if IsValid(ply) and ply:GetNW2Bool("observer") then
		return true
	end
end)