local files, folders = file.Find("darkrp_modules/deceive/translations/*.lua", "LUA")
if SERVER then
	for _, fn in pairs(files) do
		AddCSLuaFile("darkrp_modules/deceive/translations/" .. fn)
	end
	return
end
...
for _, fn in pairs(files) do
	...
	deceive.Languages[lang] = include("darkrp_modules/deceive/translations/" .. fn) -- CompileFile("deceive/translations/" .. fn)()
end
