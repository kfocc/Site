...
-- list.Add( "OverrideMaterials", "phoenix_storms/Fender_chrome" ) -- Cubemap No depth
-- list.Add( "OverrideMaterials", "phoenix_storms/Fender_white" ) -- No depth
...
--list.Add( "OverrideMaterials", "models/props/cs_assault/moneywrap02" ) --материал пищевой пленки
...
--list.Add( "OverrideMaterials", "phoenix_storms/metalfence004a" ) -- СЕТКА
--list.Add( "OverrideMaterials", "models/props/cs_assault/fireescapefloor" ) -- https://f.unionrp.info/threads/47972/#post-514212
--list.Add( "OverrideMaterials", "models/props_interiors/metalfence007a" ) -- СЕТКА

local RemoveMats = {"models/screenspace", "debug/env_cubemap_model"}
timer.Simple(0, function()
	local mats = list.GetForEdit("OverrideMaterials")
	for k, v in pairs(RemoveMats) do
		table.RemoveByValue(mats, v)
	end
