...
SKIN.Background = Color(10, 10, 10, 220)
SKIN.Header = Color(215, 100, 75, 255)
...
SKIN.ProgressBar = Color(215, 170, 105, 255)
SKIN.DMenuBackground = Color(30, 30, 30, 255)
plogs.ui = SKIN
----------------------------------------------------------------
-- Frames
----------------------------------------------------------------
...
function SKIN:PaintMenu(self, w, h)
	plogs.draw.OutlinedBox(0, 0, w, h, SKIN.DMenuBackground, SKIN.Outline)
end
...
function SKIN:PaintMenuOption(self, w, h)
	...
	if self.m_bBackground and (self.Hovered or self.Highlight) then plogs.draw.OutlinedBox(0, 0, w, h, SKIN.ButtonHovered, SKIN.Outline) end
end
