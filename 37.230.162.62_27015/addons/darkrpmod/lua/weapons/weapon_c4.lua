if SERVER then AddCSLuaFile("weapon_c4.lua") end
...
function SWEP:PrimaryAttack()
	if SERVER then
		...
		c4:SetPos(tr.HitPos + Vector(0, 0, 15))
		c4:Spawn()
		c4.ItemOwner = self:GetOwner()
		...
		if not tr.Hit then c4:SetMoveType(MOVETYPE_VPHYSICS) end
		self:GetOwner():EmitSound("c4.PlantSound")
		self:GetOwner():StripWeapon("weapon_c4")
	end
end
