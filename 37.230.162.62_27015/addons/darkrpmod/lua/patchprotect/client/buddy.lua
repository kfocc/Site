...
concommand.Add("pprotect_reset_buddies", function()
	...
	print("[PProtect-Buddy] Вы успешно очистили список друзей.")
end)
...
function cl_PProtect.setBuddy(bud, c)
	...
	if c and c == true then
		cl_PProtect.ClientNote("Вы выдали " .. bud:Nick() .. " доступ к своим пропам!", "info")
		-- Send message to buddy
		net.Start("pprotect_info_buddy")
		net.WriteEntity(bud)
		net.SendToServer()
	else
		cl_PProtect.ClientNote("Вы отобрали у " .. bud:Nick() .. " доступ к своим пропам!", "info")
	end
