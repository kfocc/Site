gib_models = {"models/hunter/blocks/cube025x025x025.mdl", "models/props_c17/consolebox01a.mdl", "models/props_lab/reciever01b.mdl", "models/props_c17/pulleywheels_large01.mdl", "models/xqm/jetenginepropellerhuge.mdl", "models/props_lab/plotter.mdl",}
local ExplosionSound = {"ambient/explosions/explode_1.wav", "ambient/explosions/explode_2.wav", "ambient/explosions/explode_3.wav", "ambient/explosions/explode_4.wav", "ambient/explosions/explode_5.wav", "ambient/explosions/explode_8.wav", "ambient/explosions/explode_9.wav",}
function EFFECT:Init(data)
	self.Pos = data:GetOrigin()
	self.CreatedTime = CurTime()
	self.Emitter = ParticleEmitter(self.Pos)
	if math.random(1, 2) == 1 then sound.Play(table.Random(ExplosionSound), self.Pos, math.random(50, 70)) end
...
function EFFECT:Think()
	...
	if vel < 50 then die_time = math.Rand(0.7, 1.5) end
