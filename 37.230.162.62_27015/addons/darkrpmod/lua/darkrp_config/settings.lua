...
GM.Config.microwavefoodcost = 500
...
GM.Config.minPlayerNameLength = 6
GM.Config.maxPlayerNameLength = 20
--[[---------------------------------------------------------------------------
Other settings
---------------------------------------------------------------------------]]
...
GM.Config.DisallowDrop = {
	...
	["weapon_slam"] = true,
	["cid_new"] = true,
	["tfa_crossbow_fire"] = true,
	["swb_hawkaxe"] = true,
	["zck_snowballswep"] = true,
	["tfa_mp7_zombie"] = true,
	["tfa_hl2_ar2_zombine"] = true,
	["hl2_hands"] = true
}
...
GM.Config.DefaultLaws = {"Запрещено бегать, прыгать.", "Запрещено использовать / хранить контрабанду.", "Запрещено мешать работе ГО.", "Запрещена нецензурная лексика.", "Запрещена пропаганда против Альянса.", "Запрещено заниматься повстанческой деятельностью."}
GM.Config.PocketBlacklist = {
	...
	["eml_spot"] = true,
	["eml_macid"] = true,
	["rationdispencer"] = true,
	["water"] = true,
	["keypad"] = true,
	["union_fooddispenser"] = true,
	["union_fooddispenser2"] = true,
}
