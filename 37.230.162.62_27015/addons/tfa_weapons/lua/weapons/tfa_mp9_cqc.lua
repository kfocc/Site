...
SWEP.Primary.KickUp				= 0.322		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.322		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.161		-- Maximum up recoil (stock)
...
SWEP.Primary.SpreadMultiplierMax = 1.122
SWEP.IronRecoilMultiplier = 0.622
SWEP.CrouchAccuracyMultiplier = 0.622
