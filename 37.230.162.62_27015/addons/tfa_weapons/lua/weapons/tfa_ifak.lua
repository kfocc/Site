...
SWEP.Primary.Ammo = "fas2_bandage" -- fas2_hemostat
...
SWEP.Anim = ACT_VM_PRIMARYATTACK_1
SWEP.Bodygroups_V = {
	[1] = 2 -- Убирает левую часть
}
...
function SWEP:InitBodygroups()
	...
	self.Bodygroups_V[2] = ammo == 0 and 3 or ammo < 5 and 1 or 0
end
