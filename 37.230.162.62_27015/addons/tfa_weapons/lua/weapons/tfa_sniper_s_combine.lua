...
SWEP.PrintName				= "Sniper Rifle Silent"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.KickUp			= 0.582				-- Maximum up recoil (rise)
SWEP.Primary.KickDown		= 0.582		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal	= 0.582		-- Maximum up recoil (stock)
...
SWEP.Primary.Spread		= 0.051	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0.0001 -- ironsight accuracy, should be the same for shotguns

SWEP.Primary.SpreadMultiplierMax = 1.382

SWEP.IronRecoilMultiplier = 0.882
SWEP.CrouchAccuracyMultiplier = 0.882
