...
SWEP.PrintName				= "AR2 MKII"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/c_ar2+.mdl"	-- Weapon view model
...
SWEP.Primary.KickUp				= 0.296		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.296		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.148		-- Maximum up recoil (stock)
...
SWEP.Primary.SpreadMultiplierMax = 1.196

SWEP.IronRecoilMultiplier = 0.596 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.596 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
