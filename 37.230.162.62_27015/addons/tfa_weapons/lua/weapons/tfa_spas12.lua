...
SWEP.Primary.RPM				= 82		-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 6			-- Size of a clip
SWEP.Primary.DefaultClip		= 30	-- Default number of bullets in a clip
SWEP.Primary.KickUp			    = 1.215				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 1.215		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 1.215	-- Maximum up recoil (stock)
...
SWEP.Primary.SpreadMultiplierMax = 3.715
