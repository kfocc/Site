...
SWEP.Primary.Sound			= Sound("weapons/metropolice_smg/oicw/oicw_shoot.wav")		-- script that calls the primary fire sound
SWEP.Primary.RPM				= 675		-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 30		-- Size of a clip
SWEP.Primary.DefaultClip			= 100	-- Bullets you start with
SWEP.Primary.KickUp			= 0.31				-- Maximum up recoil (rise)
SWEP.Primary.KickDown		= 0.31		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal	= 0.155		-- Maximum up recoil (stock)
...
SWEP.Primary.SpreadMultiplierMax = 1.21--How far the spread can expand when you shoot. Example val: 2.5

SWEP.IronRecoilMultiplier = 0.61 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.61 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
