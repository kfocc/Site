...
SWEP.Primary.KickUp				= 0.284		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.284		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.142		-- Maximum up recoil (stock)
...
SWEP.Primary.Spread		= 0.023	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0.003 -- Ironsight accuracy, should be the same for shotguns

SWEP.Primary.SpreadMultiplierMax = 1.084
SWEP.IronRecoilMultiplier = 0.584
SWEP.CrouchAccuracyMultiplier = 0.584
