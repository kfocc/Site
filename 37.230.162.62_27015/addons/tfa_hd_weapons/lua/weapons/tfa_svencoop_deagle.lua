...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_deagle.fire") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp				= 0.332		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.332	-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.332		-- Maximum up recoil (stock)
--Firing Cone Related
...
SWEP.Primary.SpreadMultiplierMax = 1.332 --How far the spread can expand when you shoot. Example val: 2.5
--Misc
...
SWEP.CrouchAccuracyMultiplier = 0.532 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
SWEP.MoveSpeed = 1
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/c_desert_eagle.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/w_desert_eagle.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0.8, -6, -3) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(32, 1, 0) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-2.640, 0, 1) --Change this, using SWEP Creation Kit preferably
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 1 / 60, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_deagle.reload") },
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 1 / 60, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_deagle.reload") },
{ ["time"] = 78 / 60, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_deagle.slide") },
}
