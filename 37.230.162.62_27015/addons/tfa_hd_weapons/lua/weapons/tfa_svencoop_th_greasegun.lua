...
SWEP.PrintName              = "M3 Grease Gun"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_th_greasegun.fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 710 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.SpreadMultiplierMax = 1.08 --How far the spread can expand when you shoot. Example val: 2.5
--Misc
SWEP.IronRecoilMultiplier = 0.58 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.58 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/th/c_greasegun.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/th/w_greasegun.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -4, 1) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-8, 25, 8) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.58, 0, 2.12) --Change this, using SWEP Creation Kit preferably
...
["EjectionportSafety"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.401, 0.644), angle = Angle(-12.622, 0, 0) }
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 10 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_greasegun.magout") },
{ ["time"] = 32 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_greasegun.magin") },
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 10 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_greasegun.magout") },
{ ["time"] = 32 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_greasegun.magin") },
{ ["time"] = 63 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_greasegun.bolt") },
}
