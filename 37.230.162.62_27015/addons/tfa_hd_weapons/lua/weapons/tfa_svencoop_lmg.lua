...
SWEP.Category               = "TFA Автоматы" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_lmg.fire") -- This is the sound of the weapon, when you shoot.
...
--Firing Cone Related
SWEP.Primary.Spread		= 0.024	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0 -- Ironsight accuracy, should be the same for shotguns
--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 1.14 --How far the spread can expand when you shoot. Example val: 2.5
--Misc
SWEP.IronRecoilMultiplier = 0 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.54 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
SWEP.MoveSpeed = 1
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/c_saw.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/w_saw.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -3, 2) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-6, 30, 0) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-5.20, 0, -0.16) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(6.1, 0, 0) --Change this, using SWEP Creation Kit preferably
--[[INSPECTION]]--
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 13 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_lmg.bolt") },
{ ["time"] = 48 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_lmg.cover_open") },
{ ["time"] = 70 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_lmg.belt_out") },
{ ["time"] = 90 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_lmg.box_out") },
{ ["time"] = 129 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_lmg.box_in") },
{ ["time"] = 143 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_lmg.belt_in") },
{ ["time"] = 181 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_lmg.cover_down") },
}
