...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_p90.1") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp = 0.371 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.371-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.185 -- This is the maximum sideways recoil (no real term)

--Firing Cone Related
SWEP.Primary.Spread = 0.032 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.012 -- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 1.171 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.671 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.671 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_p90.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_p90.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(0, -2, -2)
SWEP.RunSightsAng = Vector(-5.869, -30.129, 16.056)
...
SWEP.IronSightsPos = Vector(6.119, -5.154, -0.04)
SWEP.IronSightsAng = Vector(3.105, 5.403, 0.708)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.19,-2,0.1) --Vector to move bone <or root> relative to bone <or view> orientation.
