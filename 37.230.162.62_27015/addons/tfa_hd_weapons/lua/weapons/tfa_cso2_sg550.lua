...
SWEP.Category				= "TFA Снайперки" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "SIG SG550"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_sg550.1") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp = 0.408 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.408-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.408 -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadMultiplierMax = 1.208 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.708 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.708 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_sg550.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_sg550.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector( -0.5, -6, -0.5)
...
SWEP.IronSightsPos = Vector(9.68, -3.592, 1.84)
SWEP.IronSightsAng = Vector(-2.8, 3.299, 0)
--[[INSPECTION]]--
