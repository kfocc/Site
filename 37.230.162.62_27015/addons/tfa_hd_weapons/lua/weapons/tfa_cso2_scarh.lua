...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_scar_h.1") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp = 0.319 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.319-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.159 -- This is the maximum sideways recoil (no real term)

--Firing Cone Related
SWEP.Primary.Spread = 0.031 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.011 -- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 1.219 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.619 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.619 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_scarh.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_scarh.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(8.88, -3.592, 1.639)
SWEP.IronSightsAng = Vector(0, 0.8, 0.223)
