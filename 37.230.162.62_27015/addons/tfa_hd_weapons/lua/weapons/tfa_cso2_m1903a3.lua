...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m1903a3.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m1903a3.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m1903a3.mdl" -- Weapon world model path
...
SWEP.BoltTimerOffset = 5 --How long you stay sighted in after shooting, with a bolt action.
...
SWEP.RunSightsPos = Vector(-0.75, -4, -0.5)
SWEP.RunSightsAng = Vector(-14.869, -35.129, 16.056)
...
SWEP.IronSightsPos = Vector(4.695, -6.005, 1.879)
SWEP.IronSightsAng = Vector(-1.685, 3.055, 0.882)
--[[INSPECTION]]--
...
SWEP.Sights_Mode = TFA.Enum.LOCOMOTION_LUA -- ANI = mdl, LUA = lua but continue idle, Lua = stop mdl animation
SWEP.Sprint_Mode = TFA.Enum.LOCOMOTION_LUA -- ANI = mdl, LUA = ani + lua, Lua = lua only
