...
SWEP.PrintName				= "Masada"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_acr.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("tfa_cso2_acr.2") -- This is the sound of the weapon, when silenced.
...
SWEP.DisableChambering = false --Отключить патрон в патроннике

--Recoil Related
SWEP.Primary.KickUp = 0.253 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.253 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.126 -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadMultiplierMax = 1.153 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.553 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.553 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_acr.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_acr.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.382, -7.718, 1.24)
SWEP.IronSightsAng = Vector(1.391, -0.502, 0)
