...
SWEP.Category               = "TFA Пистолеты" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName              = "Colt Detective Special"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_357.fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 73 -- Damage, in standard damage points.
...
--Recoil Related
SWEP.Primary.KickUp				= 0.328		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.328		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.328		-- Maximum up recoil (stock)
--Firing Cone Related
SWEP.Primary.Spread		= 0.026	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0.006 -- Ironsight accuracy, should be the same for shotguns
--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 1.328 --How far the spread can expand when you shoot. Example val: 2.5
--Misc
SWEP.IronRecoilMultiplier = 0.528 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.528 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
SWEP.MoveSpeed = 1
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/th/c_th_38.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 65        -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip          = false     -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0,3,0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/th/w_th_38.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -6, -4) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(40, -2, 0) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-5.655, 0, 3.68) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably
--[[INSPECTION]]--
SWEP.InspectPos = Vector(0,-4,0) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(15,20,0) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 6 /40 , ["type"] = "sound", ["value"] = Sound("weapon_svencoop_357.open") },
{ ["time"] = 20 /40 , ["type"] = "sound", ["value"] = Sound("weapon_svencoop_357.shellsout") },
{ ["time"] = 54 /40 , ["type"] = "sound", ["value"] = Sound("weapon_svencoop_357.shellsin") },
{ ["time"] = 61 /40 , ["type"] = "sound", ["value"] = Sound("weapon_svencoop_357.speedloader") },
{ ["time"] = 77 /40 , ["type"] = "sound", ["value"] = Sound("weapon_svencoop_357.close") },
},
[ACT_VM_FIDGET] = {
{ ["time"] = 23 / 30 , ["type"] = "sound", ["value"] = Sound("weapon_svencoop_357.fidgetpull") },
{ ["time"] = 84 / 30 , ["type"] = "sound", ["value"] = Sound("weapon_svencoop_357.fidgetrelease") },
}
