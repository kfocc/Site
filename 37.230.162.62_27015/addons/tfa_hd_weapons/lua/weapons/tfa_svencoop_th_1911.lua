...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_th_1911.fire") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp				= 0.311		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.311		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.311		-- Maximum up recoil (stock)
--Firing Cone Related
...
SWEP.Primary.SpreadMultiplierMax = 1.311 --How far the spread can expand when you shoot. Example val: 2.5
--Misc
SWEP.IronRecoilMultiplier = 0.511 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.511 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
SWEP.MoveSpeed = 1
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/th/c_1911.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/th/w_1911.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -4, -4) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-3.44, 0, 1.2) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(1, 0, 0) --Change this, using SWEP Creation Kit preferably
--[[INSPECTION]]--
SWEP.InspectPos = Vector(6,0,-5) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(17,20,0) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 16 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_1911.magout") },
{ ["time"] = 58 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_1911.magin") }
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 16 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_1911.magout") },
{ ["time"] = 58 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_1911.magin") },
{ ["time"] = 78 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_1911.slide") }
},
