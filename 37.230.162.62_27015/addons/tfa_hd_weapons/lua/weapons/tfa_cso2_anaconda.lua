...
SWEP.PrintName				= "Colt Anaconda"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp = 0.336 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.336 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.336 -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadMultiplierMax = 1.336 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.536 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.536 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
