...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m4a1_new.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("tfa_cso2_m4a1_new.2") -- This is the sound of the weapon, when silenced.
...
--Firing Cone Related
SWEP.Primary.Spread = 0.024 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.004 -- Ironsight accuracy, should be the same for shotguns
...
--Misc
SWEP.IronRecoilMultiplier = 0.54 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_mk18.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_mk18.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.524, -6.363, 1.559)
SWEP.IronSightsAng = Vector(0.782, -0.493, 6.647)
...
SWEP.BlowbackVector = Vector(6.538, -8.363, 1.58) - SWEP.IronSightsPos  --Vector to move bone <or root> relative to bone <or view> orientation.
