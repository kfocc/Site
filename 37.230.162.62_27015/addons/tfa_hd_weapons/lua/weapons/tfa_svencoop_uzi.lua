...
SWEP.Category               = "TFA ПП" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_uzi.fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 875 -- This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.KickUp				= 0.265		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.265		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.132		-- Maximum up recoil (stock)
--Firing Cone Related
...
SWEP.Primary.SpreadMultiplierMax = 1.065--How far the spread can expand when you shoot. Example val: 2.5
--Misc
SWEP.IronRecoilMultiplier = 0.565 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.565 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/c_uzi.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/w_uzi.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(2, -2, 0.7) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-11, 17, 0) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.08, 0, -1.69) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(7.8, 0.2, 0) --Change this, using SWEP Creation Kit preferably
--[[INSPECTION]]--
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 22 / 60, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_uzi.magout") },
{ ["time"] = 84 / 60, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_uzi.magin") },
{ ["time"] = 123 / 60, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_uzi.bolt") },
},
[ACT_VM_DRAW] = {
{ ["time"] = 1 / 60, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_uzi.draw") },
}
