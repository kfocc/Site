...
SWEP.Category               = "Не используется" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/c_357.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/w_357.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-0.6, -3, 2) --Change this, using SWEP Creation Kit preferably
