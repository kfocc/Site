...
SWEP.Primary.RPM = 820 -- This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.KickUp = 0.329 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.329 -- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.SpreadMultiplierMax = 1.129 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.629 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.629 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
