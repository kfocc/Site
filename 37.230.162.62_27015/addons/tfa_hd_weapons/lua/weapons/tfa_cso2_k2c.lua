...
SWEP.PrintName				= "K2C"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_k2c.1") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp = 0.304 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.304 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.152 -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadMultiplierMax = 1.204--How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.604 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.604 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_k2c.mdl" --Viewmodel path
...
--[[INSPECTION]]--
SWEP.InspectPos = Vector(-3.401, 0, -2.441)
SWEP.InspectAng = Vector(20.886, -14.016, 5.79)

--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(9.369, -5.36, -4.14)
SWEP.RunSightsAng = Vector(26.214, 34.21, 8.572)

--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_k2c.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(12.319, 0, 3.079)
SWEP.IronSightsAng = Vector(-2.465, 5.347, 6.244)
