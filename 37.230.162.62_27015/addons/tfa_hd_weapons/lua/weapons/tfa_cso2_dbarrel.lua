...
SWEP.Category				= "TFA Дробовики" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--Recoil Related
SWEP.Primary.KickUp = 1.806 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 1.806 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 1.806 -- This is the maximum sideways recoil (no real term)

--Firing Cone Related
SWEP.Primary.Spread = 0.13 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.105 -- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 4.306 --How far the spread can expand when you shoot. Example val: 2.5
