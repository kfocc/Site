...
SWEP.PrintName              = "Beretta"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_pistol.fire") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp				= 0.318		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.318		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.318		-- Maximum up recoil (stock)
--Firing Cone Related
...
SWEP.Primary.SpreadMultiplierMax = 1.318 --How far the spread can expand when you shoot. Example val: 2.5
--Misc
SWEP.IronRecoilMultiplier = 0.518 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.518 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
SWEP.MoveSpeed = 1
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/c_9mmhandgun.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/w_9mmhandgun.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -6, -3.5) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(47, -0.3, 0) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-5.4, 0, 1.60) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(-2.5, -5.7, 0) --Change this, using SWEP Creation Kit preferably
--[[INSPECTION]]--
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 8 / 28, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_pistol.magout") },
{ ["time"] = 27 / 28, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_pistol.magin") },
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 8 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_pistol.magout") },
{ ["time"] = 27 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_pistol.magin") },
{ ["time"] = 38 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_pistol.click") },
},
[ACT_VM_DRAW] = {
{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_pistol.twirl") },
},
