...
SWEP.PrintName				= "MK23"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_mk23.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("tfa_cso2_mk23.2") -- This is the sound of the weapon, when silenced.
...
SWEP.NZPaPName				= "Starter Destruction"
...
--Recoil Related
SWEP.Primary.KickUp = 0.351 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.351 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.351 -- This is the maximum sideways recoil (no real term)

--Firing Cone Related
SWEP.Primary.Spread = 0.029 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.009 -- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 1.351 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.551 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.551 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_mk23.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_mk23.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(0, -9, -6)
SWEP.RunSightsAng = Vector(50, 10, 0)
...
SWEP.IronSightsPos = Vector(6.28, -2.641, 1.86)
SWEP.IronSightsAng = Vector(1.899, 0, 0)
...
SWEP.BlowbackBoneMods = {
	["weapon.USP_Slide"] = { scale = Vector(1, 1, 1), pos = Vector(-1.563, 0, 0), angle = Angle(0, 0, 0) }
