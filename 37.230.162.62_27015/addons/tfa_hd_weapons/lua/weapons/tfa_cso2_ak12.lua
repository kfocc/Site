...
SWEP.PrintName				= "Izhmash AK-12"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM = 775 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.KickHorizontal = 0.143 -- This is the maximum sideways recoil (no real term)

--Firing Cone Related
SWEP.Primary.Spread = 0.028 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.008 -- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 1.187--How far the spread can expand when you shoot. Example val: 2.5
