...
--Recoil Related
SWEP.Primary.KickUp = 1.046 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 1.046 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 1.046  -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadMultiplierMax = 3.546 --How far the spread can expand when you shoot. Example val: 2.5
