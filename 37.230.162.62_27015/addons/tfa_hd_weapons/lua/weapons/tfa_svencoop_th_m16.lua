...
SWEP.PrintName              = "Colt AR-15"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_svencoop_th_m16.fire") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp				= 0.341		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.341		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.17		-- Maximum up recoil (stock)
--Firing Cone Related
SWEP.Primary.Spread = 0.034 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.014 -- Ironsight accuracy, should be the same for shotguns
--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 1.241 --How far the spread can expand when you shoot. Example val: 2.5
--Misc
SWEP.IronRecoilMultiplier = 0.641 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.641 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
SWEP.MoveSpeed = 1
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/svencoop/th/c_th_m16.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/svencoop/th/w_th_m16.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -1, 1) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-6, 25, -10) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.165, 0, 0.96) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(-0, -0, 2) --Change this, using SWEP Creation Kit preferably
--[[INSPECTION]]--
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 11 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_m16.magout") },
{ ["time"] = 41 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_m16.magin") },
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 11 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_m16.magout") },
{ ["time"] = 41 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_m16.magin") },
{ ["time"] = 59 / 30, ["type"] = "sound", ["value"] = Sound("weapon_svencoop_th_m16.bolt") },
},
