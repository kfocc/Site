...
SWEP.Category				= "TFA Разное" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.Primary.ProjectileModel = "models/items/ar2_grenade.mdl"
