...
SWEP.PrintName				= "Daewoo K5"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_k5.1") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp = 0.327 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.327 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.327 -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadMultiplierMax = 1.327 --How far the spread can expand when you shoot. Example val: 2.5

--Misc
SWEP.IronRecoilMultiplier = 0.527 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.527 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_k5.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_k5.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(0, -8, -5)
...
SWEP.IronSightsPos = Vector(4.54, -3.188, 2.44)
SWEP.IronSightsAng = Vector(0, -0.529, 0)
...
SWEP.BlowbackBoneMods = {
	["K5_Slider"] = { scale = Vector(1, 1, 1), pos = Vector(0, -1.476, 0), angle = Angle(0, 0, 0) }
...
function SWEP:k5loy( ... )
	BaseClass.k5loy( self, ... )
	timer.Simple(0.01, function()
		if not IsValid(self) then return end
		if not self:VMIV() then return end
		self:CleanParticles()
		ParticleEffectAttach( "ss_k5_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 5 )
		ParticleEffectAttach( "ss_k5_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 6 )
	end)
	return true
end
