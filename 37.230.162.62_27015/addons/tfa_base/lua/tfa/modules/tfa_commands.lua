...
if GetConVar("sv_tfa_damage_mult_min") == nil then
	CreateReplConVar("sv_tfa_damage_mult_min", "1", "This is the lower range of a random damage factor.")
end

if GetConVar("sv_tfa_damage_mult_max") == nil then
	CreateReplConVar("sv_tfa_damage_mult_max", "1", "This is the higher range of a random damage factor.")
end
