...
local function tfaOptionServer(panel)
	...
	tfaOptionSV.Options["#preset.default"] = {
		...
		sv_tfa_damage_mult_min = "1",
		sv_tfa_damage_mult_max = "1",
...
local function tfaOptionHUD(panel)
	...
	AddColorMixer(xhairpnl, "#tfa.hudsettings.crosshair.color", "cl_tfa_hud_crosshair_color_r", "cl_tfa_hud_crosshair_color_g", "cl_tfa_hud_crosshair_color_b", "cl_tfa_hud_crosshair_color_a")
	xhairpnl:CheckBox("#tfa.hudsettings.crosshair.teamcolor", "cl_tfa_hud_crosshair_color_team")
	AddColorMixer(xhairpnl, "#tfa.hudsettings.crosshair.teamcolor.enemy", "cl_tfa_hud_crosshair_color_enemy_r", "cl_tfa_hud_crosshair_color_enemy_g", "cl_tfa_hud_crosshair_color_enemy_b")
	AddColorMixer(xhairpnl, "#tfa.hudsettings.crosshair.teamcolor.friendly", "cl_tfa_hud_crosshair_color_friendly_r", "cl_tfa_hud_crosshair_color_friendly_g", "cl_tfa_hud_crosshair_color_friendly_b")
	...
	AddColorMixer(xhairpnl, "#tfa.hudsettings.crosshair.outline.color", "cl_tfa_hud_crosshair_outline_color_r", "cl_tfa_hud_crosshair_outline_color_g", "cl_tfa_hud_crosshair_outline_color_b", "cl_tfa_hud_crosshair_outline_color_a")
	...
	AddColorMixer(hmpnl, "#tfa.hudsettings.hitmarker.color", "cl_tfa_hud_hitmarker_color_r", "cl_tfa_hud_hitmarker_color_g", "cl_tfa_hud_hitmarker_color_b", "cl_tfa_hud_hitmarker_color_a")
