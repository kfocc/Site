...
SWEP.PrintName = "Сломанный демократизатор"
SWEP.Author = "UnionRP"
...
SWEP.VElements = {
	["stunstick"] = { type = "Model", model = "models/weapons/w_stunbaton.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.25, 0.5, 6.25), angle = Angle(-90, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
