...
SWEP.VElements = {
	["crowbar"] = { type = "Model", model = "models/weapons/w_crowbar.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, 8.25), angle = Angle(-90, 33, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
