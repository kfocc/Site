...
SWEP.UseHands = true
SWEP.Type_Displayed = "Small Sharp Weapon"
SWEP.Author = "UnionRP"
SWEP.Slot = 0
SWEP.PrintName = "Нож"
...
--[Model]--
SWEP.ViewModel = "models/weapons/tfa_l4d_mw2019/melee/c_knife.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel = "models/weapons/tfa_l4d_mw2019/melee/w_knife.mdl"
SWEP.HoldType = "knife"
...
--[Gun Related]--
SWEP.Primary.Sound = Sound("weapon_mw2019_knife.swing_miss")
SWEP.Primary.Sound_Hit = Sound("weapon_mw2019_knife.swing_world")
SWEP.Primary.Sound_HitFlesh = Sound("weapon_mw2019_knife.swing_flesh")
...
SWEP.EventTable = {
	["deploy"] = {
		{time = 7 / 30, type = "sound", value = "weapon_mw2019_knife.draw"},
	},
}
