...
--[Model]--
SWEP.ViewModel = "models/weapons/tfa_l4d_mw2019/melee/c_e_tool.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel = "models/weapons/tfa_l4d_mw2019/melee/w_e_tool.mdl"
SWEP.HoldType = "melee"
...
--[Gun Related]--
SWEP.Primary.Sound = Sound("weapon_mw2019_e_tool.swing_miss")
SWEP.Primary.Sound_Hit = Sound("weapon_mw2019_e_tool.swing_world")
SWEP.Primary.Sound_HitFlesh = Sound("weapon_mw2019_e_tool.swing_flesh")
...
SWEP.EventTable = {
	["deploy"] = {
		{time = 1 / 30, type = "sound", value = "weapon_mw2019_e_tool.draw"},
	},
}
