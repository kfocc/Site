...
SWEP.VElements = {
	["spade"] = { type = "Model", model = "models/weapons/w_spade.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.25, 0.5, 23), angle = Angle(-180, 90, 0), size = Vector(0.75, 0.75, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["spade"] = { type = "Model", model = "models/weapons/w_spade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.4, 1.5, -23), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
