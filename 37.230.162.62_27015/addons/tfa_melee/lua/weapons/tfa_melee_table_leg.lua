...
SWEP.VElements = {
	["table_leg"] = { type = "Model", model = "models/gibs/furniture_gibs/furnituredrawer002a_gib05.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.5, 12), angle = Angle(0, 0, 0), size = Vector(1.5, 1.5, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["table_leg"] = { type = "Model", model = "models/gibs/furniture_gibs/furnituredrawer002a_gib05.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.5, -12), angle = Angle(0, 0, 180), size = Vector(1.5, 1.5, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
