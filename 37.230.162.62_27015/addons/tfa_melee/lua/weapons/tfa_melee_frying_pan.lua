...
SWEP.Primary.Attacks = {
	{
		...
		["hitflesh"] = "SolidMetal.ImpactSoft",
		["hitworld"] = "SolidMetal.ImpactSoft"
	},
	{
...
SWEP.Secondary.Attacks = {
	{
		...
		["hitworld"] = "SolidMetal.ImpactHard"
	},
	{
...
SWEP.BlockCone = 30 --Think of the player's view direction as being the middle of a sector, with the sector's angle being this
...
SWEP.VElements = {
	["frying pan+"] = { type = "Model", model = "models/props_c17/metalPot002a.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.5, 0, 7.5), angle = Angle(90, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["frying pan"] = { type = "Model", model = "models/props_c17/metalPot002a.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.5, 0, 7.5), angle = Angle(90, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["frying pan"] = { type = "Model", model = "models/props_c17/metalPot002a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 0, -10), angle = Angle(-90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
