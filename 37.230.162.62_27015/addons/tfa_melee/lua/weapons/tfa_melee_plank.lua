...
SWEP.VElements = {
	["plank"] = { type = "Model", model = "models/props_debris/wood_chunk03c.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.5, 0, 20), angle = Angle(0, 90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["plank"] = { type = "Model", model = "models/props_debris/wood_chunk03c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, -20), angle = Angle(0, -90, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
