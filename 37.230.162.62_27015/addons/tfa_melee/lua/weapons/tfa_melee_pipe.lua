...
SWEP.VElements = {
	["gas pipe"] = { type = "Model", model = "models/props_canal/mattpipe.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.5, 5), angle = Angle(0, 90, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
