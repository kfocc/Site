...
SWEP.UseHands = true
SWEP.Type_Displayed = "3 Iron"
SWEP.Author = "UnionRP"
SWEP.Slot = 0
SWEP.PrintName = "Клюшка"
SWEP.DrawCrosshair = true

--[Model]--
SWEP.ViewModel = "models/weapons/tfa_l4d_mw2019/melee/c_golfclub.mdl"
...
--[Gun Related]--
SWEP.Primary.Sound = Sound("weapon_mw2019_golf_club.swing_miss")
SWEP.Primary.Sound_Hit = Sound("weapon_mw2019_golf_club.swing_world")
...
SWEP.EventTable = {
	["deploy"] = {
		{time = 7 / 30, type = "sound", value = "weapon_mw2019_golf_club.draw"},
	},
}
