...
--[Model]--
SWEP.ViewModel = "models/weapons/tfa_l4d_mw2019/melee/c_katana.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel = "models/weapons/tfa_l4d_mw2019/melee/w_katana.mdl"
SWEP.HoldType = "melee"
...
--[Gun Related]--
SWEP.Primary.Sound = Sound("weapon_mw2019_katana.swing_miss")
SWEP.Primary.Sound_Hit = Sound("weapon_mw2019_katana.swing_world")
SWEP.Primary.Sound_HitFlesh = Sound("weapon_mw2019_katana.swing_flesh")
...
SWEP.EventTable = {
	["deploy"] = {
		{time = 7 / 30, type = "sound", value = "weapon_mw2019_katana.draw"},
	},
}
