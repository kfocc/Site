if SERVER then
	include("lib/server/chttp.lua")
	AddCSLuaFile("init.lua")
	AddCSLuaFile("lib/pon.lua")
	AddCSLuaFile("lib/hook.lua")
	AddCSLuaFile("lib/md.lua")
	AddCSLuaFile("lib/sfs.lua")
...
if SERVER then
	include("lib/server/union_init.lua")
	include("lib/server/server_version.lua")

	include("lib/server/mysqloo.lua")
	include("lib/server/spawn_checker.lua")
	include("lib/server/team.lua")
	include("lib/server/usergroup.lua")
	AddCSLuaFile("lib_init.lua")
else
	rndx = include("lib/rndx.lua")
end
include("lib_init.lua")