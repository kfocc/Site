...
SWEP.ViewModel = "models/armorkit/c_armorkit_rebel_union.mdl"
SWEP.WorldModel = "models/armorkit/w_armorkit_rebel_union.mdl"
SWEP.UseHands = true
...
function SWEP:SecondaryAttack()
	...
	if ply:Alive() then
		...
		if armor < maxarmor then
			local int_armor = math.min(ply:Armor() + 3, maxarmor)
